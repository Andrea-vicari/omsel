		...
		<React.Fragment>
			<section id="contact" className={"pt-5 pb-5 " + bgType + " " + textType}>
				...
				<div className="container">
					...
					<p className="section-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure esse dolore error nesciunt mollitia odit.</p>
					...
					<div className="row pb-1">
						...
						<h1 className="text-center pt-3">Drop us a line</h1>
